package com.mona.cardetection.config;
...
import com.mona.cardetection.CropActivity;
import com.mona.cardetection.R;
import com.mona.cardetection.adapter.AspectRatioPreviewAdapter;
...
public class CropViewConfigurator implements StorageModule, ConfigChangeListener,
    ...
    public CropViewConfigurator(CropIwaView cropIwaView, MaterialPreferenceScreen screen) {
        ...
        this.saveConfig = new CropIwaSaveConfig.Builder(CropActivity.createNewEmptyFile());

        this.seekBarPreference = screen.findViewById(R.id.scale_seek_bar);
